## How to contribute to `entur/gha-npmjs`
...
- **Ensure the bug was not already reported** by searching on GitHub under [Issues](https://github.com/entur/gha-npmjs/issues)

- If you're unable to find an open issue addressing the problem, [open a new one](https://github.com/entur/gha-npmjs/issues/new). Be sure to include a **title and clear description**, a link to a workflow run demonstrating the bug and a description of the expected behavior
